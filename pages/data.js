data = [
  {
    ...
    no_orbit: true,
    custom: [
      ['ระยะเวลาโคจรรอบทางช้างเผือก', '230', 'ล้านปี (โลก)'],
      ['ระยะห่างจากจุดศูนย์กลางทางช้างเผือก', '27,200', 'ปีแสง'],
      ['จำนวนดาวเคราะห์บริวาร', '8', 'ดวง'],
    ],
  },
  {
    name: 'ดาวพุธ',
  ...
  },
  {
    ...
    no_orbit: true,
    custom: [
      ['มวลทั้งหมด', '4%', 'ของดวงจันทร์'],
      ['ระยะห่างจากดวงอาทิตย์', '2.2-3.2', 'AU'],
      ['จำนวนดาวเคราะห์แคระ', '1', 'ดวง'],
    ],
  },
  {
    name: 'ดาวพฤหัสบดี',
